...
HARMONIZED_DICT = os.path.join(ROOT_DIR, "reference/RADx-rad_legacy_dict_2025-01-14.csv")
GLOBAL_HARMONIZED_DICT = os.path.join(ROOT_DIR, "reference/RADx-global_tier1_dict_2025-01-14.csv")
TIER1_HARMONIZED_DICT = os.path.join(ROOT_DIR, "reference/RADx-rad_tier1_dict_2025-01-14.csv")
TIER2_HARMONIZED_DICT = os.path.join(ROOT_DIR, "reference/RADx-rad_tier2_dict_2025-01-14.csv")
